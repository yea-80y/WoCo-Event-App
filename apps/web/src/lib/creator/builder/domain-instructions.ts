...
const INSTRUCTIONS: Record<string, ProviderInstructions> = {
  Cloudflare: {
    ...
    cnameSteps: [
      ...
      'Click Add record',
      'Type: CNAME | Name: www (or subdomain) | Target: sites.woco-net.com',
    ...
    gotcha: "Set proxy to DNS Only (grey cloud) — Proxied mode intercepts traffic before it reaches our server.",
  },
  GoDaddy: {
    provider: "GoDaddy",
    apexSupported: true,
