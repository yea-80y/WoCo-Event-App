<script lang="ts">
  ...
  // Escapes the organiser's text BEFORE substituting, so every tag in the
  // output is one the renderer wrote. Lives in its own module so the property
  // can be unit-tested — see render-markdown.ts for the invariant.
