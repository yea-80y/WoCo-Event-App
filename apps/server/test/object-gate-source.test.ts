 ...
 * anything that can be down. `validateObjectGate` guards the money path
...
import type { CertObjectGate, ChainObjectGate, ObjectGate } from "@woco/shared";
import { validateObjectGate } from "../src/lib/object/gate-check.js";
