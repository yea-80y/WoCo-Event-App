...
// ---------------------------------------------------------------------------
// Money — integer minor units, never floats (fiat/USDC must round-trip exactly)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Pricing — server prices every line from the live catalog. Client-supplied
// prices are NEVER trusted (same posture as ticket claims).
// ---------------------------------------------------------------------------
